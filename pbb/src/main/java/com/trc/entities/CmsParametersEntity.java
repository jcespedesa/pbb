...
public class CmsParametersEntity 
{
	@Id
    ...
    {
        return "CmsParameterEntity [paramid="+ paramid +",priznak="+ priznak +",param1="+ param1 +",param2="+ param2 +",param3="+ param3 +",param4="+ param4 +",sentence1="+ sentence1 +",sentence2="+ sentence2 +",sentence3="+ sentence3 +",sentence4="+ sentence4 +",text1="+ text1 +",text2="+ text2 +",text3="+ text3 +",text4="+ text4 +",strobe="+ strobe +"]";
    }
